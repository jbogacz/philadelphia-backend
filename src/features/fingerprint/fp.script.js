<<<<<<< HEAD
var PhiladelphiaJS = function(exports) {
  "use strict";
  ...
  function isIPad() {
      ...
      return countTruthy([ "MediaSource" in window, !!Element.prototype.webkitRequestFullscreen, screenRatio > .65 && screenRatio < 1.53 ]) >= 2;
  }
  ...
  function isAndroid() {
      ...
      var c = "connection";
      if (isItChromium) {
          return countTruthy([ !("SharedWorker" in w), n[c] && "ontypechange" in n[c], !("sinkId" in new Audio) ]) >= 2;
      } else if (isItGecko) {
  ...
  function isSamsungInternet() {
      ...
      return countTruthy([ "srLatency" in audioPrototype, "srChannelCount" in audioPrototype, "devicePosture" in n, visualViewport && "segments" in visualViewport, "getTextInformation" in Image.prototype ]) >= 3;
  }
  ...
  function getVendorFlavors() {
      var flavors = [];
      for (var _i = 0, _a = [ "chrome", "safari", "__crWeb", "__gCrWeb", "yandex", "__yb", "__ybro", "__firefox__", "__edgeTrackingPreventionStatistics", "webkit", "oprt", "samsungAr", "ucweb", "UCShellJava", "puffinDevice" ]; _i < _a.length; _i++) {
          var key = _a[_i];
              ...
              switch (_d.label) {
                ...
                case 1:
                  ...
                  activeBlockers = filterNames.filter((function(filterName) {
                      ...
                      return blockedCount > selectors.length * .6;
                  }));
                  activeBlockers.sort();
